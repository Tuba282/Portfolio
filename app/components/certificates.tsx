        ...
        <div id='certificates'>
            ...
            <div className="flex justify-center flex-wrap gap-10 items-center my-32">
                ...
                <div className="pro-card grid justify-center items-center ">
                    ...
                    <Link target='_blank' style={{ margin: '0 auto' }} className='flex justify-start items-center '  href="/web-1-Banoqabil-Certificate.pdf" >
                ...
                <div className="pro-card grid justify-center items-center ">
                    ...
                    <Link target='_blank' style={{ margin: '0 auto' }} className='flex justify-start items-center ' href="/SBTE-Banoqabil-Certificate.pdf" >
                        <Icon icon="ci:external-link" className="cer_icon rounded-full" />
                        <h5 className=' mx-2'>Check Out ... </h5>
                    </Link>
                </div>
                ...
                <div className="pro-card grid justify-center items-center ">
                    ...
                    <Link target='_blank' style={{ margin: '0 auto' }} className='flex justify-start items-center ' href="/LRN-Banoqabil-Certificate.pdf" >
                        <Icon icon="ci:external-link" className="cer_icon rounded-full" />
                        <h5 className=' mx-2'>Check Out ... </h5>
                    </Link>
                </div>
